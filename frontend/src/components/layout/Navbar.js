            ...
            {currentUser ? (
              <>
                <li className="nav-item profile-dropdown">
                  ...
                  <span className="username">{currentUser?.user?.username || 'Deleted User'}</span>
                    {currentUser?.user?.avatar ? (
                      <img
                        src={
                          currentUser.user.avatar.startsWith('http')
                          ? currentUser.user.avatar
                          : `http://localhost:5000${currentUser.user.avatar}`
                        }
                        alt="User avatar"
                        className="avatar"
                      />
                      ...
                      <div className="avatar-placeholder">
                        {currentUser?.user?.username?.charAt(0).toUpperCase() || 'D'}
                      </div>
                    )}
                  </div>
